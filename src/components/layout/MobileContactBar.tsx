...
export default function MobileContactBar() {
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 shadow-[0_-8px_30px_rgba(0,0,0,0.12)] backdrop-blur-xl lg:hidden"
    ...
    >
      <div className="grid h-16 grid-cols-2 gap-2 p-2">
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-copper-600 px-3 font-bold text-white shadow-md active:bg-copper-700 active:scale-[0.98] transition-all"
        >
          ...
          <span className="text-sm">7/24 Hemen Ara</span>
        </a>
        <a
          href={whatsappHref}
          target="_blank"
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-3 font-bold text-white shadow-md active:bg-[#1EBE5D] active:scale-[0.98] transition-all"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
